...
void ControlSystem::network_handle(std::size_t i,
...
void ControlSystem::solo_handle(std::size_t i,
                                ecs::sparse_array<ecs::Velocity>& velocities,
                                ecs::sparse_array<ecs::Controllable>& controllables) {
    if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up)) {
...
void ControlSystem::update(Registry& registry, client::Client& network, bool isSolo) {
