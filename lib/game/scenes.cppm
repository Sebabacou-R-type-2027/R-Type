    ...
    struct game_scene : public ecs::scene {
        ...
        protected:
            void create_entities() noexcept override
            {
                ...
                // _entities.push_back(spawn_enemy_chaser(_entities.back(), {400.0f, 200.0f}));
                // _entities.push_back(spawn_enemy_chaser(_entities.back(), {600.0f, 200.0f}));
        ...
        private:
            ...
            ecs::entity create_player() noexcept
            {
                ...
                _game.emplace_component<components::id>(player, 0);
            ...
            ecs::entity spawn_enemy_spawner(ecs::components::position position) noexcept
            {
                ...
                _game.emplace_component<id>(e, 3);
