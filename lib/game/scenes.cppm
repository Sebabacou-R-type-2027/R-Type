...
struct lobby_menu : public ecs::scene {
        ...
        private:
            ...
            void initUI() {
                ...
                // input rectangle for Join lobby code
                // auto join_lobby_input = _game.create_entity();
                // _game.emplace_component<ecs::components::position>(join_lobby_input, (_game.display.window->get_size().x - 400.0f) / 2, (_game.display.window->get_size().y - 40.0f) / 2 - 40.0f);
